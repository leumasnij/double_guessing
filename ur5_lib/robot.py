...
class Robot():
  """ The robot object. """
  def __init__(self, acc_scale_factor = 1.0, vel_scale_factor = 1.0):
    """
  ...
  def move_to_oriented_location(self, loc_x, loc_y, loc_z, q_x, q_y, q_z, q_w, ask_confirmation=True):
    """
    Move to specified location.
    ...
    :param loc_y: float; the absolution y location in meters.
    :param loc_z: float; the absolution z location in meters.
    :param q_x: float; the x component of quaternion.
    :param q_y: float; the y component of quaternion.
    :param q_z: float; the z component of quaternion.
    :param q_w: float; the w component of quaternion.
    :param ask_confirmation: bool; ask user to confirm before execute.
    """
    pose_goal = geometry_msgs.msg.Pose()
    pose_goal.orientation = self.move_group.get_current_pose().pose.orientation
